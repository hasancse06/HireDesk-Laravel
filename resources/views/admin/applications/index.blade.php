...
@section('title', 'All Applications | HireDesk Laravel')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>All Applications</h1>
            <p class="text-muted mb-0">Platform-wide job application overview.</p>
        </div>
        ...
        <form method="GET" action="{{ route('admin.applications.index') }}">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <a href="{{ route('admin.applications.index') }}" class="btn btn-secondary btn-block">
                            Reset
                        </a>
                    </div>
                </div>
            ...
            <table class="table table-hover table-bordered">
                ...
                @forelse ($applications as $application)
                    <tr>
                        ...
                        <td>{{ $application->jobPost->employer->name }}</td>
